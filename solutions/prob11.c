...
Given an array element N, the adjacent elements' indicies are as follows, assuming
the new lina is at 20:
...
int main() {
    ...
    for(int i = 0; i <= 400; i++) {
        ...
        // i, i+20, i+40, i+60
        if(i + 60 < 400) {
            int product = array[i] * array[i+20] * array[i+40] * array[i+60];
            if(product > largest) largest = product;
        }
        // i, i-20, i-40, i-60
        if(i - 60 > 0) {
        ...
        // i, i + 21, i + 42, i + 63
        if(i + 63 < 400) {
            int product = array[i] * array[i+21] * array[i+42] * array[i+63];
            if(product > largest) largest = product;
        }
        // i, i + 19, i + 38, i + 57
        if(i + 57 < 400) {
            int product = array[i] * array[i+19] * array[i+38] * array[i+57];
            if(product > largest) largest = product;
        }
        // i, i - 21, i - 42, i - 63
        if(i - 63 > 0) {
